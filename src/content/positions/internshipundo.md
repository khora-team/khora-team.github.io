---
title:  Implementation, visualisation et démonstration d'algorithmes d'undo/redo pour la programmation exploratoire
starts: 2027
duration: 3-6 months
position: internship
...
summary: Implémenter d'autres algorithmes et d'en faire la démonstration au travers d'applications Web, en particulier dans le contexte de la programmation
---

## Description

Il existe différents algorithmes d'undo/redo. Cependant, seul le plus basique est actuellement utilisé dans les applications. La bibliothèque Interacto fournit d'autres algorithmes et des démonstrations de leurs usages. Par exemple l'undo/redo sous forme d'arbre : https://people.irisa.fr/Arnaud.Blouin/cpoo2-sudoku.mp4 Le but de ce stage est d'implémenter d'autres algorithmes et d'en faire la démonstration au travers d'applications Web. Le type d'applications Web à développer sera en lien avec la programmation (utilisation d'undo/redo lors du développement) pour faciliter l'exploration de solutions. Technologies : TypeScript, Angular, Jest
